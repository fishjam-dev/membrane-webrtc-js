...
export interface Endpoint {
   ...
   * can be set using {@link WebRTCEndpoint.addTrack}. Track id is generated by RTC engine.
   */
  trackIdToMetadata: Map<string, any>;

  /**
   * Mapping between track's id (generated by rtc engine) and its simulcast config. Track simulcast config
   * can be set using {@link WebRTCEndpoint.addTrack}. Track id is generated by RTC engine.
   */
  trackIdToSimulcastConfig: Map<String, SimulcastConfig>;
}
...
>) {
  ...
  private localEndpoint: Endpoint = {
    ...
    trackIdToSimulcastConfig: new Map()
  };
